 ...
 *
 * @brief Contains the completed methods for the Motor, MotorSystem, Sensor,
 *        SensorSystem and LCD data structures. This API is meant to make
 *        programming more organized and more logical for middle school level,
 *        high school level and university level teams participating the
 *        VEX ROBOTICS COMPETITION (TM).
 *
